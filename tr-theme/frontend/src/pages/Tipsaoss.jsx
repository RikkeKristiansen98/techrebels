...
const TipsaOss = () => {
  ...
  return (
    ...
    <div
      className="relative z-10 rounded-lg w-full xxs:w-[80%] md:w-[60%] xl:h-[30%] xl:w-[30%] p-6 bg-greenTheme bg-opacity-80"
    >
    ...
    <div className="absolute top-0 left-0 w-full h-full z-0 overflow-hidden">
      <svg
        ...
        className="absolute top-[-3%] left-[50%] w-[150%] xxs:w-[95%] xxs:h-[80%] md:w-[100%] h-[90%] transform -translate-x-1/2 scale-[1.2] object-cover opacity-90"
      >
        <path
          fill="#16697A"
