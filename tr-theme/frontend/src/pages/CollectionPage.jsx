      ...
      <div className="relative flex flex-col justify-center items-center min-h-screen m-[14%] mb-[6%]">
        <div className="mb-[12%] relative">
          ...
          <svg
            ...
            className="absolute top-[-60%] w-[100%] h-[200%] scale-[2] object-cover opacity-90 z-0"
          >
            <path
              fill="#16697A"
          ...
          <svg
            viewBox="0 0 200 200"
            xmlns="http://www.w3.org/2000/svg"
            className="absolute top-[-40%] w-[105%] h-[120%] scale-[3.8]  object-cover opacity-80 z-0"
          >
            <path
              fill="#A5C882"
          ...
          <h1 className="header-1 text-orangeTheme relative text-2xl sm:text-3xl lg:text-6xl font-bold text-center z-10 mb-[20%]">
            Tipsbanken
          </h1>
        </div>
