export const CollectionItemSection = () => {
    ...
    return (
        <div className="bg-pinkTheme relative flex flex-col justify-center items-center h-auto w-full lg:flex-row lg:items-start lg:justify-between py-10 md:py-[10%] lg:py-[8%] lg:px-[12%]">
            {/* Border element top */}
            <img
                src={borderElement}
                alt="Hero Element"
            ...
            <div className="relative w-full h-auto flex flex-col justify-center py-16 lg:w-1/2 lg:px-5">
                {/* Title and Author */}
                <div className="flex flex-col justify-center pr-5 mb-6 lg:mb-0">
