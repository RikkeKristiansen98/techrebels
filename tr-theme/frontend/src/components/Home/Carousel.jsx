            ...
            >
              ...
              {getVisibleCarouselItems().map((carouselItem, index) => (
                <div
                  ...
                  key={index} 
                >
                  {/* Skicka färdig data (inklusive header och imageSrc) som props */}
                  <CarouselItem 
                    header={carouselItem.acf?.header || "Header not found"} 
                    imageSrc={carouselItem.imageSrc} // Bild-URL från tidigare laddad data
                  />
                </div>
              ))}
            </div>
