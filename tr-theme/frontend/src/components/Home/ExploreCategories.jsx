...
const ExploreCategories = ({ banner_icons, banner_header, banner_tagline }) => {
  return (
    <div className="explore-categories flex bg-blueTheme h-96 relative my-20 flex-col sm:flex-row">
    {/* Text container */}
    <div className="text-container h-full flex flex-col justify-center w-full sm:w-1/2 relative overflow-hidden mb-2 sm:mb-0">
      <div className="explore-categories-text text-white px-5 sm:px-20 relative z-10 sm:block">
        ...
        <div className="absolute top-0 right-0 w-full h-16 bg-orangeTheme sm:w-[200%] sm:h-[200%] sm:rounded-full xxs:hidden xs:hidden sm:block"></div>
        </div>
